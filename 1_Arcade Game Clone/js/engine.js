...
var Engine = (function(global) {
    ...
    function render() {
        ...
        for (row = 0; row < DEFINE.ROW_NUMBER; row++) {
            for (col = 0; col < DEFINE.COL_NMUBER; col++) {
                 ...
                 */
                ctx.drawImage(Resources.get(rowImages[row]), col * DEFINE.IMAGE_WIDTH, row * DEFINE.IMAGE_HEIGHT);
            }
        }
